  ...
  return (
    <main className="app-shell">
      <header className="topbar">
        <div className="brand"><span className="brand-mark"><Icon name="dna" /></span><span>IEI Variant Review</span><span className="version">MVP 0.3</span></div>
...
function DatasetSetupCard({
  ...
  onDownload: (resourceId: "spliceai" | "clinvar") => void;
}) {
  ...
  const canToggle = !source.required && source.available && source.setup_mode !== "deferred";
  const downloadId = source.download_id as "spliceai" | "clinvar" | undefined;
...
function AnnotationPanel({ onReviewFile }: { onReviewFile: (files: File[]) => void }) {
  ...
  async function downloadResource(resourceId: "spliceai" | "clinvar") {
    setServiceError("");
    try {
